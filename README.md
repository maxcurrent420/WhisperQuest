...
🖼️ **Scenario Images and Image Generation:** (Optional-not yet fully implemented) Visualize the scenes with AI-generated images based on the narrative. Currently the Clay Hammer and Star Quest scenarios have a static graphic included.
...
🖼️ **Improved Image Generation:** Implement more image generation options for higher quality and more visually appealing scenes.
...
📂 **images:** A directory containing static scenario images.
